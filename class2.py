...
print(addDimension[np.newaxis,:].shape)#add the new dimension withe the (1,5)
print(addDimension[:np.newaxis].shape)#add the new dimension withe the (5,1)
print(np.expand_dims(addDimension,axis=0).shape)#new dimension also added by this 